...
public class BoardController {
	...
	*/
	...
	// addBoard() 서비스가 반환한 값 0 또는 1을 가지고 /board/list.do으로 이동(redirect)한다.
	...
	public String add(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		redirectAttributes.addFlashAttribute("addResult", boardService.addBoard(request));	// redirect는 FlashAttribute로 사용한다.
																							// addAttribute를 사용한다면 Model처럼 한 번만 동작 되지만 FlashAttribute는 list.do 까지 사용 가능하다.
